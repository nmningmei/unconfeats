...
for _hidden_units in [2,5,10,20,50,100,300]:
    for _dropout_rate in [0,0.25,0.5,0.75]:
        # experiment control
        model_dir               = '../models'
        ...
        results_dir             = '../results/all_for_all_zero_noise_image'
        ...
        for ii_var,var in enumerate(noise_levels):
            ...
            dd=pd.DataFrame(metrics.confusion_matrix(y_trues[:,-1],y_preds[:,-1]>0.5),
