...
This experiment was created using PsychoPy2 Experiment Builder (v1.85.3),
    on Mon 01 Apr 2019 03:40:38 PM CEST
...
trials = data.TrialHandler(nReps=1, method='random', 
    ...
    trialList=data.importConditions('csvs/experiment (sessions {},block {} fMRI).csv'.format(session,block)),
...
for thisTrial in trials:
    ...
    while continueRoutine:
        ...
        frameRemains = 0.0 + jitter_delay_dur- win.monitorFramePeriod * 0.75  # most of one frame period left
